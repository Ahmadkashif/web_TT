        ...
        return(
            <div className = "WWEDOJM1_main header">
                <div className="jumbotron jumbotron-fluid mb-0 d-felx flex-column blackOverlay col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 w-100 pt-0 pb-0">
                    ...
                    <div className = "p-2">
                    <div className="d-flex flex-column  justify-content-center my-auto WWEdoMainHeading col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <h1 className="d-flex flex-column mt-5 pt-5 display-2 mx-auto mb-0"><strong>{this.props.title}</strong></h1>
                    </div>
                    </div>
                    <div className = "p-2"></div>
                    </div>
