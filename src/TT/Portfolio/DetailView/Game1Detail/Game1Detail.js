...
class Game1Detail extends Component{
    render(){
        return(
                ...
                <div className = "PTJM1_main">
                    <div className="jumbotron jumbotron-fluid blackOverlay">
                        <div className="container d-flex justify-content-center mt-5">
                            <h1 className="display-4 PTJM1_main_Header mt-5 pt-5">Scary Clown</h1>
                        </div>
                    </div>  
                </div>
                    ...
                    <div className = "row">
                        ...
                        <div className = "col-xl-4 col-lg-4 col-md-0 col-sm-0">
                            ...
                            <div className = "container mb-2">
                                ...
                                <p>Experience the new mysterious scary clown horror escape house game titled as Scary Horror Clown Escape Game 2020 Free. Play as a creepy crazy killer clown in the escape survival house and spend the horror night in fear.</p>
                                <h2 >Get it now:</h2>
                                <ul className = "detailViewLinks">
