    ...
    render(){
        return (
            <div className = "navCustDesign d-flex justify-content-center">
                    <button className="navbar-toggler d-flex ml-auto" type="button" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
